...
@section('content')
  ...
  <section class="setting-form-wrapper">
    <div id="setting-form-wrapper" class="flex justify-around flex-col sm:flex-row p-3 space-x-2 items-start m-auto">
      <div class="w-11/12 mb-4 sm:w-6/12 mb-10 sm:mb-0">
      ...
      <form action="{{ route('dashboard.users.settings') }}" method="POST" 
        ...
        <div class="form-control pb-4 pl-1">
          <label for="password_confirmation" class="sr-only">New Password</label>
